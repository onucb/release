...
case "$ARCH" in
  aarch64-3.10)
    FEED_URL="https://onucb.github.io/release/keenetic/aarch64-k3.10"
    ;;
  mipsel-3.4)
    FEED_URL="https://onucb.github.io/release/keenetic/mipselsf-k3.4"
    ;;
  mips-3.4)
    FEED_URL="https://onucb.github.io/release/keenetic/mipssf-k3.4"
    ;;
  *)
...
echo "Setup install repo to keenetic complete."
